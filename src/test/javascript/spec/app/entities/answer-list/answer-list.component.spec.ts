...
import { AnswerListComponent } from 'app/entities/answer-list/answer-list.component';
...
describe('Component Tests', () => {
  describe('AnswerList Management Component', () => {
    let comp: AnswerListComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AnswerListComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.answerLists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
