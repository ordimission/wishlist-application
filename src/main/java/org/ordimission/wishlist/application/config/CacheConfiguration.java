package org.ordimission.wishlist.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.ordimission.wishlist.application.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.ordimission.wishlist.application.repository.UserRepository.USERS_BY_EMAIL_CACHE);
